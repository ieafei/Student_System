...
@WebServlet(name = "LookStudent_name")
public class LookStudent_name extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String name=request.getParameter("LookStudent_name");
        ...
        try{
            ...
            if(!rs.next()){
                request.setAttribute("message", "姓名不存在！请重新输入");
                request.getRequestDispatcher("LookStudent_name.jsp").forward(request, response);
            }
